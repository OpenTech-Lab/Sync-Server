...
CREATE TABLE guild_score_events (
...
CREATE INDEX idx_guild_score_events_user_created_at
    ON guild_score_events (user_id, created_at DESC);

CREATE INDEX idx_guild_score_events_event_type
    ON guild_score_events (event_type, created_at DESC);
